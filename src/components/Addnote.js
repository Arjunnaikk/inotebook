      ...
      <div className="container bg-warning">
        ...
        <form>
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="title" name="title" value={note.title} onChange={onChange} minLength={1} required/>
          ...
          <button type="submit" disabled={note.title.length<1 || note.description.length<1} className="btn btn-dark" onClick={handleClick}>Add Note</button>
        </form>
      </div>
    </>
  )
